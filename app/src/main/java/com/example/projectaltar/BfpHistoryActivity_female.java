...
public class BfpHistoryActivity_female extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bfp_history_female);
    ...
    private List<String> getBfpHistory(SharedPreferences sharedPrefs) {
        ...
        for (int i = 1; i <= entryCount; i++) {
            ...
            String bfpHip = sharedPrefs.getString("bfpHip" + i, "");
    ...
    private void showSearchDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(BfpHistoryActivity_female.this);
        builder.setTitle("Search BMR History");

        LayoutInflater inflater = LayoutInflater.from(BfpHistoryActivity_female.this);
